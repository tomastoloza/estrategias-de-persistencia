...
UPDATE CAJAS SET ALMACEN = NULL WHERE ALMACEN = (SELECT ALMACEN FROM ALMACENES, CAJAS WHERE ALMACEN = CODIGO GROUP BY ALMACEN, CAPACIDAD HAVING COUNT(NUM_REFERENCIA) > CAPACIDAD);
